...
// تأكدي من عمل import لشاشة البروفايل هنا
    ...
    return Scaffold(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => const ProfileScreenDriver(), // تأكدي من اسم الكلاس عندك
                                  ),
                                );
                              },
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.confirmation_number_outlined), label: 'Add Tickets'),
